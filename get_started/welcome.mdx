...
<Note type="warning">
  ...
  This is a mock developer portal and API reference created for demonstration purposes.

  This documentation is fully customizable to match any staking provider's branding and user interface. It is designed for seamless integration into your platform or website and is entirely managed by Adamik.

  No need to build or maintain it yourself—it just works.
</Note>
...
- **Multichain Staking** – Seamlessly integrate more than 40+ PoS networks** (**[see supported networks](http://localhost:3000/get_started/supported_chains)**).
...
<Steps>
  <Step title="Discover What the API Can Do">
    Read our **5-minute guide** on the [API Architecture](/api_overview/API_Architecture) to find the best fit for your use case.
  </Step>

  <Step title="API Overview">
    Take a look at [API Overview](/get_started/overview) to get familiar with the main modules the API offers.
  </Step>

  <Step title="API Reference">
    Check out our [**API Reference**](/api-reference/open-api-specification) to explore the full functionalities of the Meria Staking API.
  </Step>
